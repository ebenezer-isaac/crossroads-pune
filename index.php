...
<body>
            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                ...
                <p>Our focus is to provide a support system for young people through our relationships with them as we
                  provide services like counseling, academic coaching, leadership development, value based and life
                  skills enhancement sessions.</p>
                <p>We believe that a young person who is shaped and molded in the right way today will make a big
                  difference in society as they grow into men and women of character, integrity and service.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div id="free-quote" class="free-quote">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading  wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
            ...
            <p style="color: white;padding-bottom: 3rem;">Get Flat Rs.150 off for every friend you bring along. </p>
            <div class="line-dec"></div>
          </div>
        </div>
    ...
    <p style="color: white;position: absolute;bottom: 10px;right: 10px;font-size: x-small;">* Terms and Conditions Apply
    </p>
  </div>
                        ...
                        <div class="info-post">
                          <div class="icon">
                            <ul>
                              ...
                              <li>
                                <a href="tel:+919886147528">Godly: 9886147528 <br> Sumanth: 7620052882</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div class="info-post">
                          <div class="icon">
                            <ul>
                              ...
                              <li>
                                <a href="mailto:punecrossroads@gmail.com ">punecrossroads @gmail.com</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div class="info-post">
                          <div class="icon">
                            <ul>
                              ...
                              <li>
                                <a href="https://maps.app.goo.gl/2aA4TU5cvPML45XeA">Baner, Pune, Maharashtra</a>
                              </li>
                            </ul>
                          </div>
                        </div>
